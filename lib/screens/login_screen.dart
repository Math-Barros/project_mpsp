                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              //Botao
                                ...
                                child: FlatButton(
                                  child: Text("Faça login com o Google.", textAlign: TextAlign.left, style: TextStyle(
                                    fontFamily: 'Roboto',
                                  ...
                                  child: RichText(
                                    text: TextSpan(children: <TextSpan>[
                                      TextSpan(
                                        ...
                                        style: TextStyle(color: Colors.black87, fontFamily: 'Roboto', shadows: <Shadow>[
                                        Shadow(
                                          offset: Offset(0.5,0.5),
                                          blurRadius: 1.0,
                                          color: Colors.grey
                                      ...
                                      TextSpan(
                                        ...
                                        style: TextStyle(color: Colors.redAccent, fontFamily: 'Roboto', shadows: <Shadow>[
                                        Shadow(
                                          offset: Offset(0.5,0.5),
                                          blurRadius: 1.0,
                                          color: Color.fromARGB(185, 10, 10, 8)
